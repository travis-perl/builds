...
"x86_64-linux-2.6.32-042stab105.14" or
	die "Errno architecture (x86_64-linux-2.6.32-042stab105.14) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";

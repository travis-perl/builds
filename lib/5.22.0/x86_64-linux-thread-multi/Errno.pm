...
"x86_64-linux-thread-multi-2.6.32-042stab108.8" or
	die "Errno architecture (x86_64-linux-thread-multi-2.6.32-042stab108.8) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";

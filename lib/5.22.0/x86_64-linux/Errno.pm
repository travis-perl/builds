...
"x86_64-linux-2.6.32-042stab108.6" or
	die "Errno architecture (x86_64-linux-2.6.32-042stab108.6) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";

...
Perl versions from 5.003_07 to 5.31.4 are supported.
...
F<ppport.h> supports Perl versions from 5.003_07 to 5.31.4
...
=item perl 5.15.7
  ...
  toTITLE_utf8
  toUPPER_utf8
  to_utf8_fold  (DEPRECATED)
  to_utf8_lower  (DEPRECATED)
  to_utf8_title  (DEPRECATED)
  to_utf8_upper  (DEPRECATED)

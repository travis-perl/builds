...
"x86_64-linux-thread-multi-2.6.32-042stab105.14" or
	die "Errno architecture (x86_64-linux-thread-multi-2.6.32-042stab105.14) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";

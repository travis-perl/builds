...
These are instructions for building Perl under DOS and Windows, using
DJGPP v2.03 or later.  Under Windows '95, '98, ME, 2000 and XP
...
You can find instructions on how to get DJGPP here:
...
to use long file names under Windows and also to get Perl to pass all
...
Richard Dawe F<rich@phekda.freeserve.co.uk> [Updates for Perl 5.6.2]

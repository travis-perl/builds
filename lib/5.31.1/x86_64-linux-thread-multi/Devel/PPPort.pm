...
#    elif (PERL_BCDVERSION >= 0x5006001)
...
static UV DPPP_(my_utf8_to_uvchr_buf)(pTHX_ D_PPP_CU8 *s, const U8 *send, STRLEN *retlen);
static
#else
extern UV DPPP_(my_utf8_to_uvchr_buf)(pTHX_ D_PPP_CU8 *s, const U8 *send, STRLEN *retlen);
#endif
...
UV
DPPP_(my_utf8_to_uvchr_buf)(pTHX_ D_PPP_CU8 *s, const U8 *send, STRLEN *retlen)
{
    UV ret;
    STRLEN curlen;
    bool overflows = 0;

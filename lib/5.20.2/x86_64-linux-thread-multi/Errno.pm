...
"x86_64-linux-thread-multi-4.15.0-1028-gcp" or
	die "Errno architecture (x86_64-linux-thread-multi-4.15.0-1028-gcp) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
